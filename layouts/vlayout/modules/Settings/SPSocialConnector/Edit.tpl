...
<div class="container-fluid">
    ...
    <form id="MyModal" class="form-horizontal" data-detail-url="{$MODULE_MODEL->getDetailViewUrl()}">
        <div class="widget_header row-fluid">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 btn-toolbar"><div class="pull-right">
                    ...
                    {foreach item=FIELD_TYPE key=FIELD_NAME from=$FIELDS}
                        <tr><td width="25%"><label class="muted pull-right marginRight10px">{vtranslate($FIELD_NAME,$QUALIFIED_MODULE)}</label></td>
                            <td style="border-left: none;">
                                <input class="inputElement" type="{$FIELD_TYPE}" name="{$FIELD_NAME}" value="{$RECORD_MODEL->get($FIELD_NAME)}" />
</td></tr>
                    {/foreach}

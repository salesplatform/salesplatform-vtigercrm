...
<div class="table-actions">
    ...
    <span class="more dropdown action">
        {* SalesPlatform.ru begin fix dropdown *}
        <span class="dropdown-toggle"  href="javascript:;" data-toggle="dropdown"><i class="fa fa-ellipsis-v icon"></i></span>
        {* <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-ellipsis-v icon"></i></a> *}
        {* SalesPlatform.ru end fix dropdown *}

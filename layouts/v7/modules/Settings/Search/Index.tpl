					...
					{foreach from=$ModulesEntity item=item key=key}
						...
						<tr data-tabid="{$key}">
							...
							<td>
								...
								<select multiple class="select2 select2-offscreen col-md-7 fieldname" name="fieldname"> 
							...
							<td>
                                                            {*Salesplatform.ru begin Vtiger7 global search support*}
								<select multiple class="select2 select2-offscreen col-md-7 searchcolumn" name="searchcolumn">

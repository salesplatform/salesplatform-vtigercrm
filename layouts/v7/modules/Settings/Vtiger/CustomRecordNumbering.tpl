		...
		<form id="EditView" method="POST">
			<div class="blockData">
				...
				<div class="table form-horizontal no-border" id="customRecordNumbering" >
                    ...
                    <div class="row form-group" id="spcompanyRow" {if $HIDE_SP_COMPANY_ROW}style="display: none;"{/if}>
                        <div class="col-lg-3 col-md-3 col-sm-3 control-label fieldLabel">
                            <label>{vtranslate('LBL_COMPANY', $QUALIFIED_MODULE)}</label>
                        </div>
                        <div class="fieldValue {$WIDTHTYPE}">
                            <div class=" col-lg-4 col-md-4 col-sm-4">
                                <select class="select2 inputElement " name="spCompany"> 

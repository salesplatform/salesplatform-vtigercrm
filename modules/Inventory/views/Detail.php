        ...
        //SalesPlatform.ru end 
			...
			foreach ($taxDetails as $key => $taxInfo) {
                ...
                if($taxtype == 'group_tax_inc' ) { 
                    $taxDetails[$key]['taxlabel'] = vtranslate('LBL_INC_TAX') . ' ' . $taxInfo['taxlabel']; 
                } 

                $taxDetails[$key]['amount'] = htmlentities(Vtiger_Currency_UIType::transformDisplayValue($taxInfo['amount'], null, true), ENT_QUOTES | ENT_HTML401);
